...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PC3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = PIN5_Pin|PIN7_Pin|PIN6_Pin;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PC3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOC, PIN5_Pin|PIN7_Pin|PIN6_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  else if(huart->Instance==UART4)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(PIN1_GPIO_Port, PIN1_Pin);
...
void HAL_OPAMP_MspDeInit(OPAMP_HandleTypeDef* hopamp)
{
  if(hopamp->Instance==OPAMP1)
  {
    ...
    PA3     ------> OPAMP1_VOUT
    */
    HAL_GPIO_DeInit(PIN4_GPIO_Port, PIN4_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM3)
  {
    ...
    PC8     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = PIN0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(PIN0_GPIO_Port, &GPIO_InitStruct);
